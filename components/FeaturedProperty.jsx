...
const FeaturedProperty = async({property}) => {
    ...
    <div
          ...
          >
            ...
            <div className="p-6">
              ...
              >
                {property.rates.nightly && ( <p> <FaMoneyBill className="inline mr-2"></FaMoneyBill> Nightly</p>)}
                {property.rates.weekly && ( <p><FaMoneyBill className="inline mr-2"></FaMoneyBill> Weekly</p>)}
                {property.rates.monthly && ( <p><FaMoneyBill className="inline mr-2"></FaMoneyBill> Monthly</p>)}
              </div>
